...
import { useRouter, usePathname } from '@/components/UI/Minimal/routes/hooks';

import { _mock } from '@/components/UI/Minimal/_mock';
...
import { AnimateAvatar } from '@/components/UI/Minimal/components/animate';
