...
import { useAuthContext } from '@/components/UI/Minimal/auth/hooks';
import { signOut as jwtSignOut } from '@/components/UI/Minimal/auth/context/jwt/action';
import { signOut as amplifySignOut } from '@/components/UI/Minimal/auth/context/amplify/action';
import { signOut as supabaseSignOut } from '@/components/UI/Minimal/auth/context/supabase/action';
import { signOut as firebaseSignOut } from '@/components/UI/Minimal/auth/context/firebase/action';
