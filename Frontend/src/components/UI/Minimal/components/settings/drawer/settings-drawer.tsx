...
import COLORS from '@/components/UI/Minimal/theme/core/colors.json';
import { paper, varAlpha } from '@/components/UI/Minimal/theme/styles';
import { defaultFont } from '@/components/UI/Minimal/theme/core/typography';
