import type { IMail, IMailLabel } from '@/components/UI/Minimal/types/mail';
...
import { maxLine, stylesMode } from '@/components/UI/Minimal/theme/styles';

import { Label } from '@/components/UI/Minimal/components/label';
import { Editor } from '@/components/UI/Minimal/components/editor';
import { Iconify } from '@/components/UI/Minimal/components/iconify';
import { Markdown } from '@/components/UI/Minimal/components/markdown';
import { Scrollbar } from '@/components/UI/Minimal/components/scrollbar';
import { EmptyContent } from '@/components/UI/Minimal/components/empty-content';
import { FileThumbnail } from '@/components/UI/Minimal/components/file-thumbnail';
