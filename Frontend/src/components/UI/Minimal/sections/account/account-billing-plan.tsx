import type { IPaymentCard, IAddressItem } from '@/components/UI/Minimal/types/common';
...
import { PlanFreeIcon, PlanStarterIcon, PlanPremiumIcon } from '@/components/UI/Minimal/assets/icons';
