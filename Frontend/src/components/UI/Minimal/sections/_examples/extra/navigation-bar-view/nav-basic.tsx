...
import { NavBasicMobile, NavBasicDesktop } from '@/components/UI/Minimal/components/nav-basic';
...
export const NAV_ITEMS = [
  ...
  },
  {
    ...
    icon: <SvgColor src={`/assets/icons/navbar/ic-banking.svg`} />,
    info: <Label color="info">+2</Label>,
    children: [
      {
        title: 'Page 1',
        path: '/basic/page/1',
        icon: <SvgColor src={`/assets/icons/navbar/ic-booking.svg`} />,
        caption: 'This is the caption',
        info: '+3',
        children: [
      ...
      },
      {
        title: 'Page 3',
        path: '#',
        icon: <SvgColor src={`/assets/icons/navbar/ic-lock.svg`} />,
      },
    ],
  },
  {
