...
import type { LanguageValue } from '@/components/UI/Minimal/locales';
...
import { allLangs, useTranslate } from '@/components/UI/Minimal/locales';

import { FlagIcon } from '@/components/UI/Minimal/components/iconify';
