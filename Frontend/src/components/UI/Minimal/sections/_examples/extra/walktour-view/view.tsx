...
import { MotivationIllustration } from '@/components/UI/Minimal/assets/illustrations';
import {
  _mock,
...
} from '@/components/UI/Minimal/_mock';

import { Iconify } from '@/components/UI/Minimal/components/iconify';
import { Walktour, useWalktour } from '@/components/UI/Minimal/components/walktour';
import { CustomBreadcrumbs } from '@/components/UI/Minimal/components/custom-breadcrumbs';

import { EcommerceWelcome } from '@/components/UI/Minimal/sections/overview/e-commerce/ecommerce-welcome';
import { EcommerceNewProducts } from '@/components/UI/Minimal/sections/overview/e-commerce/ecommerce-new-products';
import { EcommerceYearlySales } from '@/components/UI/Minimal/sections/overview/e-commerce/ecommerce-yearly-sales';
import { EcommerceBestSalesman } from '@/components/UI/Minimal/sections/overview/e-commerce/ecommerce-best-salesman';
import { EcommerceSaleByGender } from '@/components/UI/Minimal/sections/overview/e-commerce/ecommerce-sale-by-gender';
import { EcommerceSalesOverview } from '@/components/UI/Minimal/sections/overview/e-commerce/ecommerce-sales-overview';
import { EcommerceWidgetSummary } from '@/components/UI/Minimal/sections/overview/e-commerce/ecommerce-widget-summary';
import { EcommerceLatestProducts } from '@/components/UI/Minimal/sections/overview/e-commerce/ecommerce-latest-products';
import { EcommerceCurrentBalance } from '@/components/UI/Minimal/sections/overview/e-commerce/ecommerce-current-balance';
