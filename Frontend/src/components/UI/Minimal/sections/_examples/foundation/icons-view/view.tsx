...
import { countries } from '@/components/UI/Minimal/assets/data';
import {
  GithubIcon,
  GoogleIcon,
  TwitterIcon,
      ...
      <ComponentContainer>
        ...
        <ComponentBlock title="Local icon">
          <Tooltip title="SvgColor">
            <SvgColor width={32} src={`/assets/icons/navbar/ic-dashboard.svg`} />
          </Tooltip>
          <SvgColor
            width={32}
