import type { IFileFilters } from '@/components/UI/Minimal/types/file';
...
import { CustomDateRangePicker } from '@/components/UI/Minimal/components/custom-date-range-picker';
