import type { IFileManager } from '@/components/UI/Minimal/types/file';
...
import { useDoubleClick } from '@/components/UI/Minimal/hooks//use-double-click';
import { useCopyToClipboard } from '@/components/UI/Minimal/hooks//use-copy-to-clipboard';
