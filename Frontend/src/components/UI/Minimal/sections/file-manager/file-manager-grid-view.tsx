import type { IFile } from '@/components/UI/Minimal/types/file';
import type { TableProps } from '@/components/UI/Minimal/components/table';
      ...
      <Box ref={containerRef}>
            ...
            {dataFiltered
              ...
              .map((folder) => (
                <FileManagerFolderItem
                  ...
                  onDelete={() => onDeleteItem(folder.id.toString())}
                  sx={{ maxWidth: 'auto' }}
                />
              ))}
          </Box>
            ...
            {dataFiltered
              ...
              .map((file) => (
                <FileManagerFileItem
                  ...
                  onDelete={() => onDeleteItem(file.id.toString())}
                  sx={{ maxWidth: 'auto' }}
                />
              ))}
          </Box>
        ...
        {!!selected?.length && (
          <FileManagerActionSelected
            ...
            selected={selected.map((item) => item.toString())}
