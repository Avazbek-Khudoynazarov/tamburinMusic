import type { IInvoice, IInvoiceTableFilters } from '@/components/UI/Minimal/types/invoice';
...
import { _invoices, INVOICE_SERVICE_OPTIONS } from '@/components/UI/Minimal/_mock';
