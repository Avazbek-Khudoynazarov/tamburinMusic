import type { ITourItem, ITourFilters } from '@/components/UI/Minimal/types/tour';
...
import { _tours, _tourGuides, TOUR_SORT_OPTIONS, TOUR_SERVICE_OPTIONS } from '@/components/UI/Minimal/_mock';
