import type { IPostHero } from '@/components/UI/Minimal/types/blog';
...
import { _socials } from '@/components/UI/Minimal/_mock';
import { varAlpha, bgGradient } from '@/components/UI/Minimal/theme/styles';
