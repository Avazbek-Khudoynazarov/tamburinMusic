...
import type { IDateValue } from '@/components/UI/Minimal/types/common';
...
import { _testimonials } from '@/components/UI/Minimal/_mock';
import * as CONFIG from '@/config';
import { bgBlur, varAlpha, bgGradient, hideScrollY } from '@/components/UI/Minimal/theme/styles';
    ...
    <Box
      ...
      sx={{
        ...bgGradient({
          ...
          imgUrl: `/assets/images/about/testimonials.webp`,
        }),
        overflow: 'hidden',
        height: { md: 840 },
        py: { xs: 10, md: 0 },
