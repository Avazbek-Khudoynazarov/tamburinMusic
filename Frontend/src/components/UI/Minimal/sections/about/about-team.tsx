...
import { _socials, _carouselsMembers } from '@/components/UI/Minimal/_mock';
import { TwitterIcon, FacebookIcon, LinkedinIcon, InstagramIcon } from '@/components/UI/Minimal/assets/icons';

import { Image } from '@/components/UI/Minimal/components/image';
...
import { Carousel, useCarousel, CarouselArrowFloatButtons } from '@/components/UI/Minimal/components/carousel';
