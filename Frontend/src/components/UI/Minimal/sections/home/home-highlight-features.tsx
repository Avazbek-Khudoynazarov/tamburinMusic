...
import type { UseClientRectReturn } from '@/components/UI/Minimal/hooks//use-client-rect';
...
import { useClientRect } from '@/components/UI/Minimal/hooks//use-client-rect';

import * as CONFIG from '@/config';
import { varAlpha, stylesMode } from '@/components/UI/Minimal/theme/styles';
import PRIMARY_COLOR from '@/components/UI/Minimal/theme/with-settings/primary-color.json';

import { Iconify } from '@/components/UI/Minimal/components/iconify';
import { varFade, MotionViewport } from '@/components/UI/Minimal/components/animate';
...
const ITEMS = [
  {
    ...
    imgUrl: [`/assets/images/home/highlight-darkmode.webp`],
  },
  {
    title: 'Color presets',
    ...
    imgUrl: [
      `/assets/images/home/highlight-presets-1.webp`,
      `/assets/images/home/highlight-presets-2.webp`,
      `/assets/images/home/highlight-presets-3.webp`,
      `/assets/images/home/highlight-presets-4.webp`,
      `/assets/images/home/highlight-presets-5.webp`,
    ],
  },
  {
    title: 'Right-to-left',
    ...
    imgUrl: [`/assets/images/home/highlight-rtl.webp`],
  },
];
