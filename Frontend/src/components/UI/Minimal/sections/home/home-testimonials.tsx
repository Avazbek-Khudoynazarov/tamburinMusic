...
import { maxLine, varAlpha, textGradient } from '@/components/UI/Minimal/theme/styles';

import { varFade, MotionViewport, AnimateCountUp } from '@/components/UI/Minimal/components/animate';
import {
  Carousel,
  useCarousel,
  CarouselDotButtons,
...
} from '@/components/UI/Minimal/components/carousel';
