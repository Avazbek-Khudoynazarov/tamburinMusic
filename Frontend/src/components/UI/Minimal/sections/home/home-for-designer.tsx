...
import { varAlpha, textGradient } from '@/components/UI/Minimal/theme/styles';

import { Iconify } from '@/components/UI/Minimal/components/iconify';
import { varFade, AnimateBorder, MotionViewport } from '@/components/UI/Minimal/components/animate';
  ...
  return (
    <Box
      ...
      sx={{
        ...
        minHeight: { md: 720 },
        backgroundImage: {
          xs: `linear-gradient(135deg, ${varAlpha(theme.vars.palette.grey['900Channel'], 0.8)} 0%, ${theme.vars.palette.grey[900]} 75%), url(/assets/images/home/for-designer.webp)`,
          md: `url(/assets/images/home/for-designer.webp)`,
        },
