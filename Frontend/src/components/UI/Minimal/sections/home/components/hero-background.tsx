...
import { useResponsive } from '@/components/UI/Minimal/hooks//use-responsive';

import * as CONFIG from '@/config';
import { varAlpha, stylesMode } from '@/components/UI/Minimal/theme/styles';

import { MotionContainer } from '@/components/UI/Minimal/components/animate';
    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          backgroundImage: `linear-gradient(180deg, ${theme.vars.palette.background.default} 12%, ${varAlpha(theme.vars.palette.background.defaultChannel, 0.92)} 50%, ${theme.vars.palette.background.default} 88%), url('/assets/background/background-3.webp')`,
          [stylesMode.dark]: {
            backgroundImage: `url('/assets/images/home/hero-blur.webp'), linear-gradient(180deg, ${theme.vars.palette.background.default} 12%, ${varAlpha(theme.vars.palette.background.defaultChannel, 0.96)} 50%, ${theme.vars.palette.background.default} 88%), url('/assets/background/background-3.webp')`,
          },
        }}
      />
    </Box>
