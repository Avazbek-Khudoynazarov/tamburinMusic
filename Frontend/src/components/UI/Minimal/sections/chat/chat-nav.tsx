import type { IChatParticipant, IChatConversations } from '@/components/UI/Minimal/types/chat';
...
import { createConversation } from '@/components/UI/Minimal/actions/chat';
