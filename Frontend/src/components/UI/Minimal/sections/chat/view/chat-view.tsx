import type { IChatParticipant } from '@/components/UI/Minimal/types/chat';
...
import { useGetContacts, useGetConversation, useGetConversations } from '@/components/UI/Minimal/actions/chat';

import { EmptyContent } from '@/components/UI/Minimal/components/empty-content';

import { useMockedUser } from '@/components/UI/Minimal/auth/hooks';
