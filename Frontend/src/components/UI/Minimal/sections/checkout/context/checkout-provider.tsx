import type { IAddressItem } from '@/components/UI/Minimal/types/common';
import type { ICheckoutItem, ICheckoutState, CheckoutContextValue } from '@/components/UI/Minimal/types/checkout';
...
import { useRouter, useSearchParams } from '@/components/UI/Minimal/routes/hooks';

import { getStorage, useLocalStorage } from '@/components/UI/Minimal/hooks//use-local-storage';

import { PRODUCT_CHECKOUT_STEPS } from '@/components/UI/Minimal/_mock/_product';
