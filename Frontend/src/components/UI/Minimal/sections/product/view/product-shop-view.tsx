import type { IProductItem, IProductFilters } from '@/components/UI/Minimal/types/product';
...
import { useDebounce } from '@/components/UI/Minimal/hooks//use-debounce';
import { useSetState } from '@/components/UI/Minimal/hooks//use-set-state';

import { orderBy } from '@/utils/helper';

import { useSearchProducts } from '@/components/UI/Minimal/actions/product';
import {
