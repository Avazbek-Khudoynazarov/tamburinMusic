...
import type { IProductItem, IProductTableFilters } from '@/components/UI/Minimal/types/product';
import type {
  GridSlots,
  GridColDef,
...
import { PRODUCT_STOCK_OPTIONS } from '@/components/UI/Minimal/_mock';
        ...
        >
          <DataGrid
            ...
            slotProps={{
              ...
              toolbar: { setFilterButtonEl } as { setFilterButtonEl: typeof setFilterButtonEl },
