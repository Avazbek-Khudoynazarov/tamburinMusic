...
import type { ICalendarView } from '@/components/UI/Minimal/types/calendar';
...
const VIEW_OPTIONS = [
  { value: 'dayGridMonth', label: '월 단위', icon: 'mingcute:calendar-month-line' },
  { value: 'timeGridWeek', label: '주 단위', icon: 'mingcute:calendar-week-line' },
  { value: 'timeGridDay', label: '일 단위', icon: 'mingcute:calendar-day-line' },
