import type { IClassesBoardItem, IClassesBoardReplyItem, IMemberItem, IInstrumentItem, ICurriculumItem, IClassesItem, IMetaItem, IAttachmentItem } from '@/components/UI/Minimal/types/user';
