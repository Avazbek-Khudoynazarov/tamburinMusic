// 타입 정의
import type { IPaymentsItem, ITableFilters } from '@/components/UI/Minimal/types/user';
...
const TABLE_HEAD = [
	...
	{ id: 'status', label: '결제 상태', width: 120 },
	{ id: '', width: 88 },
];
...
export function ListView() {
	...
	*/
	...
	const loadPaymentsList = useCallback(async () => {
		const data = await PaymentsService.getByTeacherId(Number(teacher_id));
		if (data) {
			setTableData(data);
		}
	}, [teacher_id]);
