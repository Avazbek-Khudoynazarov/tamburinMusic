...
import { _files, _folders } from '@/components/UI/Minimal/_mock';
...
import { UploadBox } from '@/components/UI/Minimal/components/upload';
    ...
    <FileStorageOverview
      ...
      data={[
        ...
        },
        {
          ...
          filesCount: 223,
          icon: (
            <Box component="img" src={`/assets/icons/files/ic-document.svg`} />
          ),
        },
        {
          name: 'Other',
        ...
        <Grid container spacing={3}>
          ...
          <Grid xs={12} sm={6} md={4}>
            <FileWidget
              ...
              value={GB / 10}
              total={GB}
              icon={`/assets/icons/apps/ic-app-dropbox.svg`}
            />
          </Grid>
          ...
          <Grid xs={12} sm={6} md={4}>
            <FileWidget
              ...
              value={GB / 5}
              total={GB}
              icon={`/assets/icons/apps/ic-app-drive.svg`}
            />
          </Grid>
          ...
          <Grid xs={12} sm={6} md={4}>
            <FileWidget
              ...
              value={GB / 2}
              total={GB}
              icon={`/assets/icons/apps/ic-app-onedrive.svg`}
            />
          </Grid>
