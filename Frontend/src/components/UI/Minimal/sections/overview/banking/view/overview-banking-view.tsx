...
import { _bankingContacts, _bankingCreditCard, _bankingRecentTransitions } from '@/components/UI/Minimal/_mock';

import { Iconify } from '@/components/UI/Minimal/components/iconify/iconify';
