...
import type { ColorType } from '@/components/UI/Minimal/theme/core/palette';
import type { ChartOptions } from '@/components/UI/Minimal/components/chart';
...
import { Chart, useChart } from '@/components/UI/Minimal/components/chart';
