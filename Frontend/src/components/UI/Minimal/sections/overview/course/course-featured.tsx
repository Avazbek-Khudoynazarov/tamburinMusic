...
import { maxLine } from '@/components/UI/Minimal/theme/styles';

import { Image } from '@/components/UI/Minimal/components/image';
import { Iconify } from '@/components/UI/Minimal/components/iconify';
import { Label, labelClasses } from '@/components/UI/Minimal/components/label';
import { Carousel, useCarousel, CarouselArrowBasicButtons } from '@/components/UI/Minimal/components/carousel';
