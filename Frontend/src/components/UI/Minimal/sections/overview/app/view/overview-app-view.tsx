...
import { SeoIllustration } from '@/components/UI/Minimal/assets/illustrations';
import { _appAuthors, _appRelated, _appFeatured, _appInvoices, _appInstalled } from '@/components/UI/Minimal/_mock';

import { svgColorClasses } from '@/components/UI/Minimal/components/svg-color';
