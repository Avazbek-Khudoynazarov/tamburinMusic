	...
	return (
		<>
			<TableRow hover selected={selected} aria-checked={selected} tabIndex={-1}>
				...
				<TableCell sx={{ whiteSpace: 'nowrap' }}>{row.months}</TableCell>
				<TableCell sx={{ whiteSpace: 'nowrap' }}>{row.total_classes}</TableCell>
				<TableCell sx={{ whiteSpace: 'nowrap' }}>{row.price.toLocaleString()} 원</TableCell>
